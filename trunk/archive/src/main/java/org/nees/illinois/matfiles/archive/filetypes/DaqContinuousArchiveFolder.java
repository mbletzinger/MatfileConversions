...
public class DaqContinuousArchiveFolder implements ArchiveFolderProperties {
	...
	public DaqContinuousArchiveFolder() {
	}
	...
	private void scanFolder(String folder, String sub) {
		...
		for (String f : files) {
			...
			ArchiveFileProperties afp = new DaqContinuousArchive(name, sub);
			pfiles.add(afp);
		}
	}
