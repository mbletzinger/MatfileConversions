...
public class KryptonStepArchiveFolder implements ArchiveFolderProperties {
	...
	public KryptonStepArchiveFolder() {
	}
	...
	public void scan(String folder) {
		...
		for (String f : files) {
			...
			ArchiveFileProperties afp = new KryptonStepArchive(name);
			pfiles.add(afp);
		}
	}
